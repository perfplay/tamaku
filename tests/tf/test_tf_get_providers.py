...
class TestTfGetProviders(unittest.TestCase):
    ...
    @patch('requests.get')
    def test_get_providers(self, mock_requests_get, mock_logger_info, mock_create_tasks_json, mock_load_config):
        ...
        self.assertEqual(mock_task_creator.tasks, expected_tasks)
